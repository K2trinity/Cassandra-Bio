...
def test_cross_date_refresh_expires_members_missing_from_new_snapshot(tmp_path):
    import duckdb
...
def test_chronological_refresh_closes_unchanged_member_range(tmp_path):
    import duckdb
