"""
Shared biomedical normalization helpers.

These utilities are used across harvester/supervisor/report layers to improve
stability of disease-oriented enumeration for drug classes and target signals.
"""
