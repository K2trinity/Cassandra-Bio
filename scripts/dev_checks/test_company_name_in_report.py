...
测试路径：
  1. 伪造 harvest / evidence / forensic 数据
...
FAKE_FORENSIC_DATA = [
    {
        "image_id": "Fig2A_NCT99887766",
        "status": "SUSPICIOUS",
        "tampering_risk_score": 0.82,
        "findings": "Western blot bands appear cloned; brightness pattern inconsistent across lanes."
    }
]
...
class FakeLLM:
    ...
    def invoke(self, system_prompt: str, user_prompt: str) -> str:
        ...
        for marker in ["Drug Profile", "Executive Summary", "Scientific Rationale",
                        "Dark Data", "Forensic", "Risk Assessment", "Investment Recommendation"]:
...
def run_test():
    ...
    generation_context = {
        "query": FAKE_QUERY,
        "compiled_evidence_text": FAKE_EVIDENCE_TEXT,
        "forensic_summary": FAKE_FORENSIC_DATA[0]["findings"],
        "failed_count": 0,
        "total_files": 2,
        "risk_override": None,
