"""
Cassandra Forensic Auditor - Text Processing Utilities for image forensics analysis
Handles LLM output cleaning, JSON parsing, and response extraction
"""
...
def update_state_with_search_results(search_results: List[Dict[str, Any]], 
    ...
    """
    Update state with search results from biomedical literature queries
    
    Args:
        search_results: List of search results (PubMed, ClinicalTrials.gov, etc.)
...
def format_search_results_for_prompt(search_results: List[Dict[str, Any]], 
    ...
    """
    Format biomedical search results for LLM prompt construction
    
    Args:
        search_results: List of search results from PubMed/ClinicalTrials.gov
