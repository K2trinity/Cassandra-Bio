        ...
        return [
            {
                ...
                "content": "Comprehensive overview and analysis of biomedical literature findings"
            },
            {
                "title": "In-depth Analysis",
                "content": "Detailed examination of scientific literature, research findings, and clinical implications"
            }
        ]
    ...
    def mutate_state(self, input_data: Any = None, state: State = None, **kwargs) -> State:
        ...
        try:
            ...
            if not state.report_title:
                state.report_title = f"BioHarvest Research Report: {self.query}"
